...
require_once(APP_PATH . '/Common/Common/phpqrcode.php');
...
function he_encrypt($data, $key = 'aaaaaaaccccc1111!!!-0,.;//', $expire = 0)
{
...
function he_decrypt($data, $key = 'aaaaaaaccccc1111!!!-0,.;//')
{
    $data = base64_decode($data);
    $key = md5($key);
    $x = 0;
