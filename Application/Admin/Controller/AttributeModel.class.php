...
sql;
            ...
            //新建表时是否默认新增“id主键”字段
            $model_info = M('Model')->field('engine_type,need_pk,need_cus')->getById($field['model_id']);
            if($model_info['need_pk'] && $model_info['need_cus']){
                $sql = <<<sql
