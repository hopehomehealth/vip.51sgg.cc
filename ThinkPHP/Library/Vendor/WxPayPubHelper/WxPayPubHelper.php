...
class Common_util_pub
{
	...
	public $JS_API_CALL_URL = 'http://vip.51sgg.cc/home/index/notify';
	
	//=======【异步通知url设置】===================================
	//异步通知url，商户根据实际开发过程设定
	public $NOTIFY_URL = 'http://vip.51sgg.cc/home/index/notify';
	...
	function __construct($config) {
		...
		if(isset($config['appid'])){
			...
			//=======【基本信息设置】=====================================
			//微信公众号身份的唯一标识。审核通过后，在微信发送的邮件中查看
			$this->APPID = 'wxb99447c2fa2c7695';//'wx0673e06ca2aa08e9';
			//受理商ID，身份标识
			$this->MCHID = '1420087902';//'1250389101';
			//商户支付密钥Key。审核通过后，在微信发送的邮件中查看
			$this->KEY = 'liexish163liexish163000001liexis';//'tuyoulituyoulituyoulituyouli6688';
			//JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
			//$this->APPSECRET = '7813490da6f1265e4901ffb80afaa36f';//'68a9ebfb60ce563d1810cb44d7dbb7c6';		
			//=======【证书路径设置】=====================================
			//证书路径,注意应该填写绝对路径
